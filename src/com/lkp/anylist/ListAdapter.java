...
public class ListAdapter<T> extends BaseAdapter implements Filterable {
     ...
     */
    public ListAdapter(Context context, int resource, T[] objects) {
     ...
     * @param objects The objects to represent in the ListView.
     */
    public ListAdapter(Context context, int resource, int textViewResourceId, T[] objects) {
    ...
    private View createViewFromResource(final int position, View convertView, ViewGroup parent,
      ...
      final   T item = getItem(position);
        if (item instanceof CharSequence) {
            ...
            TodoInfo td=(TodoInfo)item;
            checkBox.setText(td.getContent());
        } else {
